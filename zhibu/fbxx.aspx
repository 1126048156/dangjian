<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fbxx.aspx.cs" Inherits="fbxx" %>
...
<body>
    ...
    <div style="color: #000000">
        ...
        *文件编号：<asp:TextBox ID="TextBox1" runat="server" Width="122px" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; *标题：<asp:TextBox ID="TextBox2" runat="server" Height="18px" OnTextChanged="TextBox2_TextChanged"></asp:TextBox>
        &nbsp;&nbsp;&nbsp;<br />
        <br />
