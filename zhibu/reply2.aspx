<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reply2.aspx.cs" Inherits="reply2" EnableEventValidation="false"%>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dangjianConnectionString %>" DeleteCommand="DELETE FROM [Documents] WHERE [Name_file] = @Name_file" InsertCommand="INSERT INTO [Documents] ([Name_file], [s_sno], [destDir], [UploadDate], [d_type]) VALUES (@Name_file, @s_sno, @destDir, @UploadDate, @d_type)" SelectCommand="SELECT * FROM [Documents] WHERE ([d_type] = @d_type)" UpdateCommand="UPDATE [Documents] SET [s_sno] = @s_sno, [destDir] = @destDir, [UploadDate] = @UploadDate, [d_type] = @d_type WHERE [Name_file] = @Name_file">
            <DeleteParameters>
            ...
            <InsertParameters>
                ...
                <asp:Parameter Name="d_type" Type="String" />
            </InsertParameters>
            <SelectParameters>
                <asp:Parameter DefaultValue="思想汇报" Name="d_type" Type="String" />
            </SelectParameters>
            <UpdateParameters>
                <asp:Parameter Name="s_sno" Type="String" />
                <asp:Parameter Name="destDir" Type="String" />
