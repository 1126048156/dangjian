...
public partial class fbxx : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            conn.Open();
            String strSQL = "Select s_fname From study where s_id='" + TextBox1.Text + "'";
            ...
            if (obj != null)
            {
                ...
                string content;
                content = Doc2Text(Server.MapPath("image3/" + obj.ToString()));
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (obj != null)
        {
            ...
            String strSQL3 = "Delete From study where s_id='" + TextBox1.Text + "'";
        ...
        string destDir = Server.MapPath("./image3");
        ...
        conn2.Open();
        string sql2 = "insert into study (s_id,s_title,s_people,s_date,s_type,s_add1,s_fname) values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox5.Text + "','" + DateTime.Now.ToString("yyyy-MM-dd") + "','" + DropDownList2.Text + "','" + destPath + "','" + filename + "')";
        ...
        try
        {
            for (int iFile = 0; iFile < files.Count; iFile++)
            {
                ...
                if (fileName != "")
                {
                    ...
                    string savePath = Server.MapPath("./image3/" + TextBox1.Text + "");
                    Directory.CreateDirectory(savePath);
                    postedFile.SaveAs(System.Web.HttpContext.Current.Request.MapPath("image3/" + TextBox1.Text + "/") + fileName);
