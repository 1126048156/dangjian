...
using System.Web;
    ...
    public class Utils
    {
        ...
        public static void ShowMessage(System.Web.UI.Page page, string msg, string url)
        {
        ...
        /// <param name="msg">提示内容</param>
        /// <param name="url">跳转页面地址</param>
        public static void ShowMessage2(string msg, string url)
        {
            StringBuilder Builder = new StringBuilder();
            Builder.Append("<script language='javascript' defer>");
            Builder.AppendFormat("alert('{0}');", msg);
        ...
        public static void ShowMessage3(string msg, string url)
        {
            StringBuilder Builder = new StringBuilder();
            Builder.Append("<script language='javascript' defer>");
            Builder.AppendFormat("alert('{0}');", msg);
