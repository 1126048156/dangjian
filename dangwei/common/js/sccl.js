...
$(".dropdown-skin li a").click(function(){
	...
	$(window.frames.document).contents().find("#layoutskin").attr("href",hrefRes);
...
$(function(){
    ...
    {
        "id": "3", "name": "通知公告管理", "parentId": "1", "url": "tzgggl.aspx", "icon": "", "order": "1", "isHeader": "0", "childMenus": [

    { "id": "5", "name": "发布资讯", "parentId": "3", "url": "fbzx.aspx", "icon": "&#xe606;", "order": "1", "isHeader": "0", "childMenus": "" },
    { "id": "6", "name": "信息查询", "parentId": "3", "url": "find.aspx", "icon": "&#xe606;", "order": "1", "isHeader": "0", "childMenus": "" }
]},

{
    "id": "7", "name": "党建工作管理", "parentId": "1", "url": "djgzgl.aspx", "icon": "", "order": "1", "isHeader": "0", "childMenus": [

    { "id": "9", "name": "发布动态", "parentId": "7", "url": "updjdt.aspx", "icon": "&#xe606;", "order": "1", "isHeader": "0", "childMenus": "" },
    { "id": "10", "name": "动态查询", "parentId": "7", "url": "find1.aspx", "icon": "&#xe606;", "order": "1", "isHeader": "0", "childMenus": "" }
]},
{
    "id": "11", "name": "管理民生", "parentId": "1", "url": "knbfgl.aspx", "icon": "", "order": "1", "isHeader": "0", "childMenus": [

    { "id": "13", "name": "发布公告", "parentId": "11", "url": "fbkn.aspx", "icon": "&#xe606;", "order": "1", "isHeader": "0", "childMenus": "" }
]},

{ "id": "7", "name": "发布问卷", "parentId": "1", "url": "fbwj.aspx", "icon": "", "order": "1", "isHeader": "0", "childMenus": "" }

            ]
        },
        { "id": "7", "name": "管理主页", "parentId": "1", "url": "../../../Admin/index.aspx", "icon": "", "order": "1", "isHeader": "0", "childMenus": "" }
];
