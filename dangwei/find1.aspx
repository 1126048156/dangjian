<%@ Page Language="C#" AutoEventWireup="true" CodeFile="find1.aspx.cs" Inherits="find1" EnableEventValidation="false" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:28dayConnectionString %>" DeleteCommand="DELETE FROM [djwork] WHERE [an_id] = @an_id" InsertCommand="INSERT INTO [djwork] ([an_id], [an_title], [an_people], [an_date], [an_type], [an_add1], [an_add2], [an_fname]) VALUES (@an_id, @an_title, @an_people, @an_date, @an_type, @an_add1, @an_add2, @an_fname)" SelectCommand="SELECT * FROM [djwork] WHERE (([an_id] = @an_id) AND ([an_date] = @an_date) AND ([an_people] = @an_people) AND ([an_type] = @an_type))" UpdateCommand="UPDATE [djwork] SET [an_title] = @an_title, [an_people] = @an_people, [an_date] = @an_date, [an_type] = @an_type, [an_add1] = @an_add1, [an_add2] = @an_add2, [an_fname] = @an_fname WHERE [an_id] = @an_id" OnDataBinding="Button1_Click">
            <DeleteParameters>
