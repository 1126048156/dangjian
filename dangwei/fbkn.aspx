<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fbkn.aspx.cs" Inherits="fbkn" %>
...
<body>
    ...
    <div style="color: #000000">
        ...
        困难帮扶与志愿服务发布：<br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
        *活动编号：<asp:TextBox ID="TextBox1" runat="server" Width="122px" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; *活动主题：<asp:TextBox ID="TextBox2" runat="server" Height="19px" OnTextChanged="TextBox2_TextChanged"></asp:TextBox>
        &nbsp;&nbsp;&nbsp;<br />
        <br />
        *发布人： <asp:TextBox ID="TextBox5" runat="server"></asp:TextBox>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*截止日期：<asp:TextBox ID="TextBox4" runat="server"></asp:TextBox>
        <br />
        <br />
        *活动类型：<asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" Width="102px">
            <asp:ListItem>困难帮扶</asp:ListItem>
            <asp:ListItem>志愿服务</asp:ListItem>
        </asp:DropDownList>
&nbsp;<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <br />
