...
public partial class fbzx : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            conn.Open();
            String strSQL = "Select an_fname From announce where an_id='" + TextBox1.Text + "'";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (obj != null)
        {
            ...
            String strSQL3 = "Delete From announce where an_id='" + TextBox1.Text + "'";
        ...
        conn.Close();
            ...
            conn2.Open();
            string sql2 = "insert into announce (an_id,an_title,an_people,an_date,an_type,an_add1,an_fname) values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox5.Text + "','" + DateTime.Now.ToString("yyyy-MM-dd") + "','" + DropDownList2.Text + "','" + destPath + "','" + filename + "')";
