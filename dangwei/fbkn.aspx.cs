...
public partial class fbkn : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            conn.Open();
            String strSQL = "Select l_title From live where l_id='" + TextBox1.Text + "'";
            ...
            if (obj != null)
            {
                ...
                string content;
                content = Doc2Text(Server.MapPath("image2/" + obj.ToString()));
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (obj != null)
        {
            ...
            String strSQL3 = "Delete From live where l_id='" + TextBox1.Text + "'";
        ...
        string destDir = Server.MapPath("./image2");
        ...
        conn2.Open();
        string sql2 = "insert into live (l_id,l_title,l_people,l_date,l_type,l_add1,l_fname,l_time) values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox5.Text + "','" + DateTime.Now.ToString("yyyy-MM-dd") + "','" + DropDownList2.Text + "','" + destPath + "','" + filename + "','" + TextBox4.Text + "')";
        ...
        try
        {
            for (int iFile = 0; iFile < files.Count; iFile++)
            {
                ...
                if (fileName != "")
                {
                    ...
                    string savePath = Server.MapPath("./image2/" + TextBox1.Text + "");
                    Directory.CreateDirectory(savePath);
                    postedFile.SaveAs(System.Web.HttpContext.Current.Request.MapPath("image2/" + TextBox1.Text + "/") + fileName);
