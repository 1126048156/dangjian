<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Temple.aspx.cs" Inherits="ln2012.Admin.Class.Temple" %>
...
<body>
   ...
   <div class="navigation"><span class="add"><a href="#addClass" rel="addClass">添加类别</a></span><b>您当前的位置：首页 &gt; 自定义标签管理 &gt; 自定义标签列表</b></div>
      ...
      <ItemTemplate>
        ...
        <tr>
          <td height="22" bgcolor="#FFFFFF">
	          <div align="left">&nbsp;
	          <img src='../images/<%# Convert.ToBoolean(Eval("IsFolder"))?"tree_folder.gif":"file.gif"%>'  border="0" align="absmiddle" alt="" />
    ...
    function SelectFile(filename) 
        {
            ...
            var cateobj = opener.document.aspnetForm.ctl00$ContentPlaceHolder1$txtList;
