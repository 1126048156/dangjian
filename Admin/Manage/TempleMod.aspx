...
<body>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
       ...
       <span class="reshow">
        ...
        <asp:ListItem Value="<!--Read_key-->">meta关键字</asp:ListItem>
 ...
 <input id="Button6"  class="submit" type="button" value="内容列表标签生成" onclick="javascript:show('ChannelLabel',document.getElementById('adress'),'频道标签(点击选择)',700,380);" />
    ...
    <span class="reshow">   
        ...
        <asp:ListItem Value="{--LnClassList*2--}">带链接栏目列表标签</asp:ListItem>
        <asp:ListItem Value="{--LnClassList*3--}">带链接栏目列表标签</asp:ListItem>
